        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <button type="submit" name="submit" class="btn btn-success rounded" form="itemForm">Save &
                    New</button>
                <a href="<?php echo base_url();?>index.php/ItemController/index" class="btn btn-primary rounded">Back to
                    list</a>
        ...
        <div class="form-container">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="address-info" role="tabpanel"
                    ...
                    <form id="itemForm" class="mt-4" action="<?php echo base_url();?>index.php/ItemController/update"
                        method="post">
                            ...
                            <div class="form-row contact-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="itemCode"
                                        value="<?php echo $item->itemcode ?>" readonly>
                                </div>
                                <div class="form-group col-md-6">

                                    <label for="contact">Description </label>
                                    <textarea class="form-control" name="description" placeholder="description"
                                        rows="3"><?php echo $item->itemdescription ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="itemName"
                                    value="<?php echo $item->itemname ?>" placeholder="Item name">
                            </div>
                            <div class="form-group col-md-6">
